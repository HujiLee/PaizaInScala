...
object Prepare extends App {
  ...
  {
    var part1 = new PointPart(Array(
      "##",
      "##"
    ))
    var part2 = new PointPart(Array(
      "...##.",
      ".....#",
      "....##"
    ))
    var eq = part1 == part2
    var part2$4 = part2.$4types()
    println(eq)
  }
  ...
  val pointSet = new PointPuzzle(arrForSet)
  val goodbufferParts = ArrayBuffer(
    new PointPart(Array(
      "........",
      "..##....",
      "..##...."
  ...
  var good$ = pointSet.combinedBy4(goodbufferParts)


  var set = new mutable.LinkedHashSet[Tuple2[Int, Int]]()

  set.+=((1 -> 2), (-1 -> 5), (6 -> (-8)), (-2, 999))
  var settoarr = set.toArray
  println(set)
  for (i <- set) {
    print(i + " ")
  }
  ...
  var pset = new mutable.LinkedHashSet[Point]()
  pset.+=(new Point(1, 1), new Point(), new Point(-7, 5), new Point(-7, -1), new Point(1, 1), new Point(-5, -1), new Point(-5, 0))
  var pset1 = new mutable.LinkedHashSet[Point]()
  for (i <- pset) {
    pset1.+=(i.rotate(Rotate.$90))
  }
  var pmin = pset.min
  println(pset)
